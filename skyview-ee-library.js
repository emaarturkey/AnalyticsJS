...
// >>> IMPRESSIONS & PRODUCT DETAILS
	...
	/*
		This funciton should only be loaded on this page: https://bilet.emaarskyview.com/index.php NOT here: https://bilet.emaarskyview.com/odeme.php
	*/
	
	
	$(window).load(function () {
		if($(location).attr('href') == 'https://bilet.emaarskyview.com/index.php') {
			dataLayer.push({
				'ecommerce': {
	...
	$(window).load(function () {
		if($(location).attr('href') == 'https://bilet.emaarskyview.com/odeme.php') {
			dataLayer.push ({
				'event': 'checkout',
				'ecommerce': {
					'checkout': {
